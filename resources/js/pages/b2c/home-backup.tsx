...
import OptimizedHeroSection from '@/components/media/optimized-hero-section';
...
export default function Home() {
    ...
    return (
        <PublicLayout>
            ...
            {/* Hero Section - Starts from top of viewport, header overlays */}
            <section
                className="hero-section b2c-hero-section absolute top-0 right-0 left-0 h-screen overflow-hidden"
                style={{
                    height: '100vh',
                    maxHeight: '100vh',
                    minHeight: '100vh',
            ...
            >
                {/* Container with strict overflow control */}
                <div className="h-full w-full overflow-hidden bg-muted" style={{ height: '100%', overflow: 'hidden' }}>
                    ...
                    {/* Smooth hero content dengan strict overflow control */}
                    <AnimatePresence mode="wait" initial={false}>
                        <motion.div
                            ...
                            exit="exit"
                        >
                            <div className="max-w-full overflow-hidden text-center text-white" style={{ maxWidth: '100%', overflow: 'hidden' }}>
                                <motion.h1
            ...
            {/* Mobile-First Best Sellers Section - Positioned below hero section */}
            <motion.section
                id="packages"
