            ...
            <Dialog open={selectedArticle !== null} onOpenChange={() => setSelectedArticle(null)}>
                <DialogContent className="max-h-[98vh] max-w-[98vw] overflow-y-auto border border-amber-500/30 bg-gradient-to-br from-amber-950 via-orange-950 to-amber-900 shadow-2xl sm:max-w-[90vw] md:max-w-2xl lg:max-w-3xl xl:max-w-4xl">
                    <DialogHeader className="border-b border-amber-500/30 pb-3 sm:pb-4">
                        <DialogTitle className="bg-gradient-to-r from-amber-300 via-yellow-200 to-orange-300 bg-clip-text text-lg font-bold text-transparent leading-tight sm:text-xl md:text-2xl">
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                ...
                                <div className="relative overflow-hidden rounded-lg border border-amber-500/30">
                                    <img
                                        src={article.image}
                                        alt={article.title}
                                        className="h-40 w-full object-cover sm:h-48 md:h-56 lg:h-64"
                                    />
                                ...
                                <div className="flex flex-wrap items-center gap-3 text-xs sm:text-sm text-gray-300">
                                    <div className="flex items-center gap-1">
                                        <svg className="h-3 w-3 text-amber-400 sm:h-4 sm:w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                        </svg>
                                        <span>{article.date}</span>
                                    </div>
                                    <div className="flex items-center gap-1">
                                        <svg className="h-3 w-3 text-blue-400 sm:h-4 sm:w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        <span>{article.readTime}</span>
                                    </div>
                                    <div className="flex items-center gap-1">
                                        <svg className="h-3 w-3 text-purple-400 sm:h-4 sm:w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div className="rounded-lg bg-gradient-to-r from-amber-500/10 to-orange-500/10 p-3 sm:p-4">
                                        ...
                                        <ul className="space-y-1.5 sm:space-y-2 text-gray-300">
                                            <li className="flex items-start gap-2">
                                                <span className="mt-1 h-1 w-1 rounded-full bg-amber-400 flex-shrink-0 sm:mt-1.5 sm:h-1.5 sm:w-1.5"></span>
                                    ...
                                    <div className="rounded-lg bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-3 sm:p-4">
                                        ...
                                        <div className="grid gap-2 sm:grid-cols-2 sm:gap-3">
                                            <div className="space-y-1 sm:space-y-2">
                                                <h4 className="font-medium text-blue-200 text-xs sm:text-sm">Preparation</h4>
                                                <p className="text-xs text-gray-300 sm:text-sm">Physical and spiritual preparation for your journey</p>
                                            </div>
                                            <div className="space-y-1 sm:space-y-2">
                                                <h4 className="font-medium text-blue-200 text-xs sm:text-sm">Rituals</h4>
                                                <p className="text-xs text-gray-300 sm:text-sm">Step-by-step guide to sacred rituals</p>
                                            </div>
                                            <div className="space-y-1 sm:space-y-2">
                                                <h4 className="font-medium text-blue-200 text-xs sm:text-sm">Timing</h4>
                                                <p className="text-xs text-gray-300 sm:text-sm">Best times to visit and perform rituals</p>
                                            </div>
                                            <div className="space-y-1 sm:space-y-2">
                                                <h4 className="font-medium text-blue-200 text-xs sm:text-sm">Guidance</h4>
                                ...
                                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                                    {article.tags.map((tag) => (
                                        <span key={tag} className="rounded-full border border-amber-500/30 bg-gradient-to-r from-amber-500/20 to-orange-500/20 px-2 py-1 text-xs font-medium text-amber-300 sm:px-3">
                                            #{tag}
                                        </span>
                                    ))}
                                </div>
