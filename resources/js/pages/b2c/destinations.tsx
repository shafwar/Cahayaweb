...
const destinations = [
    ...
    },
    {
        ...
        image: 'Destination Cahaya.jpeg', // Updated with new image from Mba Hanum
        duration: '8D7N',
        price: 'Rp 16.5M',
        location: 'Cairo, Luxor, Aswan, Abu Simbel, Pyramid',
        highlights: 'Pyramids of Giza, Nile cruise, ancient temples, Valley of the Kings, Pyramid exploration',
        description:
            'Journey through the cradle of civilization and explore the mysteries of ancient Egypt. Marvel at the Great Pyramids of Giza, explore the iconic Pyramid, and cruise the majestic Nile River.',
        features: [
