        ...
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background via-muted/20 to-background p-4">
            ...
            <div className="w-full max-w-md">
                ...
                <div className="mb-8 text-center">
                    <img src="/cahayanbiyalogo.png" alt="Cahaya Anbiya" className="mx-auto mb-4 h-16" />
                ...
                <div className="rounded-lg border border-border bg-card p-6 shadow-lg">
                    ...
                    <div className="space-y-3">
                        <Button
                            ...
                            onClick={() => window.open('https://wa.me/6281234567890?text=Hi, I need help with login', '_blank')}
                        >
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-muted-foreground">
                            ...
                            <Link href={route('register')} className="font-medium text-primary transition-colors hover:text-primary/80">
                                Sign up
                            </Link>
                        </p>
                    </div>
