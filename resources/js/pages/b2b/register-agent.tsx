...
import { Briefcase, Building2, Check, FileText, Info, Mail, MapPin, Phone, Upload, User, X, AlertCircle, RefreshCw } from 'lucide-react';
...
const countryCodes = countries.map(c => c.code).filter((value, index, self) => self.indexOf(value) === index).sort((a, b) => {
                    ...
                    >
                        ...
                        {showRejectionNotice && rejectedVerification && (
                            <motion.div
                                ...
                                className="mx-auto mt-8 max-w-3xl"
                            >
                                <div className="rounded-xl border-2 border-red-500/30 bg-gradient-to-br from-red-500/10 via-red-500/5 to-red-500/10 p-6 backdrop-blur-sm shadow-lg shadow-red-500/10">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1 text-left">
                                            ...
                                            <p className="mb-4 text-sm text-gray-300 sm:text-base">
                                                Your previous application for <span className="font-semibold text-white">{rejectedVerification.company_name}</span> has been rejected.
                                ...
                                <div className="rounded-xl border border-green-500/20 bg-green-500/10 p-6 backdrop-blur-sm">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1 text-left">
                                            ...
                                            <p className="text-sm leading-relaxed text-gray-300 sm:text-base">
                                                You are already logged in. Please fill out the form below and submit your application to complete your B2B registration.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <CardContent className="space-y-6 p-6 sm:p-8">
                                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                        <div className="space-y-3">
                                            ...
                                            <Input
                                                ...
                                                required
                                            />
                                            <p className="text-xs text-gray-400">Enter your registered company name as it appears on official documents</p>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <Select value={data.business_type} onValueChange={(value) => {
                                            ...
                                            <p className="text-xs text-gray-400">Select the legal entity type that matches your company registration. If your business type is not listed, choose "Other" and specify it below.</p>
                                            ...
                                            {data.business_type === 'Other' && (
                                                ...
                                                >
                                                    <Label htmlFor="business_type_other" className="mb-2 block text-sm font-semibold text-orange-300">
                                                    ...
                                                    />
                                                    <p className="text-xs text-orange-200/80">Please provide the specific legal entity type or business structure of your company</p>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        >
                                            ...
                                            <SelectContent className="border border-gray-700 bg-gray-800 max-h-[300px] overflow-y-auto">
                                                {countries.map((country) => (
                                                    <SelectItem key={country.name} value={country.name} className="text-white hover:bg-orange-500/20">
                                                        {country.flag} {country.name} ({country.code})
                                                    </SelectItem>
                                                ))}
                                            </SelectContent>
                                        </Select>
                                        <p className="text-xs text-gray-400">Country where your company is registered. Phone country code will be automatically set based on your selection.</p>
                                    ...
                                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <p className="text-xs text-gray-400">
                                                Enter phone number without country code. For Indonesia: enter without leading 0 (e.g., 822 9986 2211 instead of 0822 9986 2211)
                                            </p>
                            ...
                            <Card className="overflow-hidden border border-gray-700/50 bg-gray-800/60 shadow-xl backdrop-blur-sm">
                                ...
                                <CardContent className="space-y-6 p-6 sm:p-8">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        />
                                        <p className="text-xs text-gray-400">Provide a brief overview of your business operations, services, and market focus</p>
                                    ...
                                    {[
                                        {
                                            ...
                                            guidance: 'Upload SIUP, NIB, or other official business license document. Ensure document is clear and readable.'
                                        },
                                        {
                                            field: 'tax_certificate_file',
                                            label: 'Tax Certificate (NPWP)',
                                            guidance: 'Upload your company\'s NPWP certificate. Document should show the complete 15-digit tax ID number.'
                                        },
                                        {
                                            field: 'company_profile_file',
                                            label: 'Company Profile',
                                            guidance: 'Upload company profile, brochure, or business overview document (optional but recommended).'
                                        },
