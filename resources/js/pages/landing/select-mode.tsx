                ...
                {showSplash && (
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center text-center px-4">
                            ...
                            <motion.div variants={logoVariants} initial="hidden" animate="visible" className="mb-8 sm:mb-10 md:mb-12">
                                <motion.img
                                    src="/cahayanbiyalogo.png"
                                    alt="Cahaya Anbiya Logo"
                                    className="h-36 w-auto sm:h-40 md:h-48 lg:h-56 xl:h-64"
                                    style={{
                            ...
                            <motion.h1
                                ...
                                initial="hidden"
                                animate="visible"
                                className="mb-3 text-lg font-light tracking-wide text-white/90 sm:mb-4 sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl"
                            ...
                            <motion.h2
                                ...
                                initial="hidden"
                                animate="visible"
                                className="relative mb-2 text-3xl font-semibold tracking-tight sm:mb-3 sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl"
                                style={{ fontFamily: 'Poppins, sans-serif' }}
                            >
                                <motion.span
                            ...
                            <motion.p
                                ...
                                initial="hidden"
                                animate="visible"
                                className="text-xs font-light tracking-widest text-white/50 sm:text-base md:text-lg lg:text-xl"
                            ...
                            <motion.div variants={dotVariants} initial="hidden" animate="visible" className="mt-8 flex gap-2 sm:mt-10 md:mt-12">
                                {[0, 1, 2].map((i) => (
                                    <motion.div
                                        key={i}
