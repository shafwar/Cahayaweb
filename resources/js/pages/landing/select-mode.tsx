    ...
    return (
        <div className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-background p-6 text-foreground">
            ...
            <AnimatePresence mode="wait">
                {showSplash && (
                    <motion.div
                        className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-br from-slate-900 via-black/20 to-slate-900"
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col items-center justify-center text-center">
                            ...
                            <motion.h1
                                ...
                                initial="hidden"
                                animate="visible"
                                className="mb-6 bg-gradient-to-br from-primary via-secondary to-accent bg-clip-text text-4xl font-bold tracking-tight text-transparent md:text-6xl lg:text-7xl"
                                style={{
                                    lineHeight: '1.1',
                            ...
                            <motion.h2
                                ...
                                initial="hidden"
                                animate="visible"
                                className="mb-8 bg-gradient-to-br from-accent via-secondary to-primary bg-clip-text text-3xl font-bold tracking-tight text-transparent md:text-5xl lg:text-6xl"
                                style={{
                                    lineHeight: '1.1',
                                    letterSpacing: '-0.02em',
                                    fontFamily: 'Playfair Display, serif',
            ...
            >
                ...
                <motion.div className="text-center" variants={cardVariants}>
                    <motion.h1
                        className="bg-gradient-to-br from-accent via-secondary to-primary bg-clip-text text-xl font-bold tracking-tight text-transparent sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl"
                        style={{
                            lineHeight: '1.1',
                            letterSpacing: '-0.02em',
                        }}
            ...
            {/* Enhanced Footer with Social Links - Fixed for Mobile (render AFTER splash) */}
            {!showSplash && (
                <motion.div
                    ...
                    <div className="mb-2 flex justify-center sm:mb-3">
                        ...
                        >
                            ...
                            <motion.a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="group flex h-6 w-6 items-center justify-center rounded-full bg-gradient-to-br from-primary via-secondary to-accent p-1 text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl sm:h-7 sm:w-7 sm:p-1.5"
                                whileHover={{
                                    scale: 1.1,
