        ...
        <div className="relative flex min-h-dvh items-center justify-center overflow-hidden bg-background p-6 text-foreground">
            ...
            >
                ...
                <div className="mb-4 flex justify-center">
                    <motion.div
                        className="flex items-center gap-3 rounded-full border border-white/20 bg-white/10 px-4 py-2 backdrop-blur-md"
                    ...
                    >
                        ...
                        <motion.a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="group flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-pink-500 via-purple-500 to-orange-500 p-2.5 text-white shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl"
                            whileHover={{
                                scale: 1.1,
                            ...
                            whileTap={{ scale: 0.95 }}
                        >
                            <svg className="h-5 w-5 transition-transform duration-300 group-hover:rotate-12" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* Copyright */}
                <div className="text-sm font-medium text-muted-foreground/80">© 2025 PT Cahaya Anbiya Wisata</div>
            </motion.div>
        </div>
    );
}
