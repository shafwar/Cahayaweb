...
try {
    createInertiaApp({
                ...
                try {
                    ...
                    try {
                        root.render(
                            ...
                            >
                                <h1 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem', color: '#111827' }}>Application Error</h1>
                                <p style={{ color: '#6b7280', marginBottom: '0.5rem' }}>Something went wrong. Please refresh the page.</p>
                                <p
                                    style={{
                                        fontSize: '0.875rem',
                                        color: '#9ca3af',
        ...
        onError: (error) => {
            ...
            if (errorStatus === 500 || errorMessage.includes('500') || errorMessage.includes('SERVER ERROR') || errorString.includes('500')) {
    ...
    if (typeof window !== 'undefined' && typeof document !== 'undefined') {
        ...
        errorDiv.style.cssText =
            'padding: 2rem; text-align: center; background-color: #f9fafb; min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center;';
        errorDiv.innerHTML = `
            <h1 style="font-size: 1.5rem; font-weight: bold; margin-bottom: 1rem; color: #111827;">Application Error</h1>
